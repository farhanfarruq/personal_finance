            ...
            SizedBox(
              ...
              child: BarChart(
                BarChartData(
                  ...
                  barGroups: [
                    BarChartGroupData(x: 0, barRods: [BarChartRodData(toY: prov.income, color: Colors.green)]),
                    BarChartGroupData(x: 1, barRods: [BarChartRodData(toY: prov.expense, color: Colors.red)]),
                  ],
                ),
              ),
            ),
